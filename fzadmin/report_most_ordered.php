...
$totalResults = getSqlNumber("SELECT id FROM order_details group by prodid");
$getRs = mysql_query("SELECT *,sum(qty) as total_qty,sum(subtotal) as total from order_details group by prodid order by total_qty desc LIMIT ".$start.",".$limit." ");
