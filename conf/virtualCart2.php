...
<tr>
<!-- ITEM NAME -->
<td style="font-size:12px;padding:0px;padding-top:8px;width: 60%;">Prawns Soup 
...
<span class='fa fa-inr' >&nbsp;</span>110</td>
</tr>
</td></tr><tr>
<!-- ITEM NAME -->
<td style="font-size:12px;padding:0px;padding-top:8px;width: 60%;">Prawns Clear Soup 
...
<div class="desktop-cart__order__subtotal-container"> <!-- INNER CONTAINER -->
		...
		<div class="desktop-cart__order__subtotal">
				<span>Subtotal</span><span class="desktop-cart__order__subtotal-price">₹ 220.00</span>
       </div>
	 ...
	 <!-- TAXES IF ANY -->	  
        ...
        <span>Delivery charge &nbsp; <span class="desktop-cart__order__delivery-price">₹ 20.00</span></span>
		 ...
		 <!-- DISCOUNT IF ANY  -->
            ...
            <span class="desktop-cart__order__total-price">₹ 240.00</span></em></b></span>
			</div>
		  </div>
