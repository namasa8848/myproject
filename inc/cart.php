...
<tr>
<!-- ITEM NAME -->
<td style="font-size:11.6px;padding:0px;padding-top:8px;width: 130px;cursor:text" title="<?php echo $rsp['name']; ?>"><?php if (strlen($rsp['name']) >= 20) { echo substr($rsp['name'], 0, 20). ".."; } else { echo $rsp['name']; }?> 
