		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<nav class="footer-nav clearfix">
						<ul class="cta footer-menu">
							<li><a href="aboutus.php">About us</a></li>
							<li><a href="faq.php">FAQ</a></li>
							<li><a href="find-my-food.php">Find My Food</a></li>
            ...
            <div class="social">
				...
				<div class="cop visible-xs">
                	<p class="copyright-text"  style="font-size:10px;"><?php echo $copyright;?></p>
				</div>
				</div> <!-- /.col-md-12 -->
			</div> <!-- /.row -->
		</div> <!-- /.container -->
...
s1.async=true;
s1.src='https://embed.tawk.to/577789c94cc88cf418f4eb55/default';
s1.charset='UTF-8';
